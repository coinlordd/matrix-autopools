...
contract StrategyTest is TestHelper {
  ...
  function test_RebalanceClose() public {
    ...
    bytes memory distributions = abi.encodePacked(
      uint64(0),
      uint64(0.5e18),
      uint64(0.5e18),
      uint64(0.5e18),
  ...
  function test_Swap() external {
    string
      memory b = "";
    ...
    b = "";
  ...
  function test_RebalanceAmounts() external {
    ...
    assertApproxEqRel(amounts[2], amounts[0] + amounts[1] + amounts[3] + amounts[4], 1e16, "test_RebalanceAmounts::3");
  }
  ...
  function test_RebalanceFar() external {
    ...
    distributions = abi.encodePacked(uint64(0), uint64(0.25e18), uint64(0), uint64(0.25e18), uint64(0), uint64(0.5e18));
