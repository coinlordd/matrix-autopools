...
contract DistributionTest is Test {
  ...
  function test_GetDistributions() external {
    ...
    (uint256 amountX, uint256 amountY, uint256[] memory distributionX, uint256[] memory distributionY) = amounts
      .getDistributions(compositionFactor, price, 1);
  ...
  function testFuzz_GetDistributions(
    ...
    (uint256 amountX, uint256 amountY, uint256[] memory distributionX, uint256[] memory distributionY) = desiredL
      .getDistributions(compositionFactor, price, index);
