...
import {IOracleVault} from "../src/interfaces/IOracleVault.sol";
...
contract VaultFactoryTest is TestHelper {
  ...
  function test_revert_InitializeImplementation() public {
    ...
    assertEq(VaultFactory(implementation).getDefaultOperator(), address(0), "test_revert_InitializeImplementation::2");
  ...
  function test_revert_CreateSimpleVault() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(
        IVaultFactory.VaultFactory__VaultImplementationNotSet.selector,
  ...
  function test_revert_CreateOracleVault() public {
    ...
    factory.setVaultImplementation(IVaultFactory.VaultType.Oracle, address(new InvalidOracleVault(address(factory))));
  ...
  function test_CreateDefaultStrategy() public {
    ...
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 0), strategy, "test_CreateDefaultStrategy::5");
  ...
  function test_CreateOracleVaultAndDefaultStrategy() public {
    ...
    assertEq(
      factory.getVaultAt(IVaultFactory.VaultType.Oracle, 0),
      vault,
      "test_CreateOracleVaultAndDefaultStrategy::12"
    );
    assertEq(
      factory.getNumberOfVaults(IVaultFactory.VaultType.Oracle),
      1,
      "test_CreateOracleVaultAndDefaultStrategy::13"
    );
  ...
  function test_CreateMultipleAPT() public {
    ...
    (oracleVaults[0], strategies[0]) = factory.createOracleVaultAndDefaultStrategy(ILBPair(wavax_usdc_20bp), dfX, dfY);
    (oracleVaults[1], strategies[1]) = factory.createOracleVaultAndDefaultStrategy(ILBPair(wavax_usdc_20bp), dfX, dfY);
    (oracleVaults[2], strategies[2]) = factory.createOracleVaultAndDefaultStrategy(ILBPair(wavax_usdc_20bp), dfX, dfY);
    ...
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 0), strategies[0], "test_CreateMultipleAPT::16");
    assertEq(
      uint8(factory.getStrategyType(strategies[0])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::17"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 1), strategies[1], "test_CreateMultipleAPT::18");
    assertEq(
      uint8(factory.getStrategyType(strategies[1])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::19"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 2), strategies[2], "test_CreateMultipleAPT::20");
    assertEq(
      uint8(factory.getStrategyType(strategies[2])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::21"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 3), strategies[3], "test_CreateMultipleAPT::22");
    assertEq(
      uint8(factory.getStrategyType(strategies[3])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::23"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 4), strategies[4], "test_CreateMultipleAPT::24");
    assertEq(
      uint8(factory.getStrategyType(strategies[4])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::25"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 5), strategies[5], "test_CreateMultipleAPT::26");
    assertEq(
    ...
    vm.startPrank(owner);
    (oracleVaults[3], strategies[6]) = factory.createOracleVaultAndDefaultStrategy(ILBPair(wavax_usdc_20bp), dfX, dfY);
    ...
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 6), strategies[6], "test_CreateMultipleAPT::35");
    assertEq(
      uint8(factory.getStrategyType(strategies[6])),
      uint8(IVaultFactory.StrategyType.Default),
      "test_CreateMultipleAPT::36"
    );
    assertEq(factory.getStrategyAt(IVaultFactory.StrategyType.Default, 7), strategies[7], "test_CreateMultipleAPT::37");
    assertEq(
